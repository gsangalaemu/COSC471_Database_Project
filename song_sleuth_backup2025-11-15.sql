...
CREATE TABLE `affiliations` (
  `Affiliation_id` int(11) NOT NULL COMMENT 'Auto-generated integer to serve as the primary key for this entity.\n',
  `Group_id` int(11) DEFAULT NULL COMMENT 'The group the artist is a member of\n. References GROUPS.Group_id\n',
...
CREATE TABLE `groups` (
  `Group_id` int(11) NOT NULL COMMENT 'Auto-generated integer to serve as the primary key for this entity.\n This method was chosen since multiple groups with the same name exist, sometimes from the same country, and even from the same region of the same country.',
  `Group_name` varchar(255) NOT NULL COMMENT 'Holds the group''s name\n'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
ALTER TABLE `affiliations`
  MODIFY `Affiliation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto-generated integer to serve as the primary key for this entity.\n';
...
--
ALTER TABLE `groups`
  MODIFY `Group_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Auto-generated integer to serve as the primary key for this entity.\n This method was chosen since multiple groups with the same name exist, sometimes from the same country, and even from the same region of the same country.';
...
--
ALTER TABLE `affiliations`
  ADD CONSTRAINT `Affiliation_Artist_ID` FOREIGN KEY (`Artist_id`) REFERENCES `artists` (`Artist_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `Affiliation_Group_ID` FOREIGN KEY (`Group_id`) REFERENCES `groups` (`Group_id`) ON DELETE SET NULL ON UPDATE CASCADE;
